...
def main(args):
    ...
    score_ar = np.concatenate(np.hsplit(score_ar, 3), axis = 0)
    ...
    if args.plot:
        ...
        plt.savefig('plot/avg_score.png',dpi=400)
        plt.close()
        ...
        plt.savefig('plot/preference.png',dpi=400)
        plt.close()
            
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--file_path', type=str, default='human_preference.csv')
